...
export async function POST(req: NextRequest) {
  try {
    ...
    const created = createDomain({
      ...
      ttsBackend: body.ttsBackend,
      stylebertvits2ModelId: body.stylebertvits2ModelId,
      stylebertvits2Style: body.stylebertvits2Style,
      ttsMuted: body.ttsMuted,
      amicaLifeEnabled: body.amicaLifeEnabled,
      timeBeforeIdleSec: body.timeBeforeIdleSec,
      minTimeIntervalSec: body.minTimeIntervalSec,
      maxTimeIntervalSec: body.maxTimeIntervalSec,
      timeToSleepSec: body.timeToSleepSec,
